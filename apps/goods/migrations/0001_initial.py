# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-03-10 11:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_tab', models.BooleanField(default=False, help_text='是否放入导航栏', verbose_name='是否放入导航栏')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(max_length=200, upload_to='brand/', verbose_name='封面图')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '品牌',
